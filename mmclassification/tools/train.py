...
def parse_args():
    ...
    parser.add_argument('--config', default="/home/hsuan/Thesis/mmclassification/configs/resnet/resnet101_warp.py", help='train config file path')
    parser.add_argument('--work-dir', default="/home/hsuan/Thesis/mmclassification/wrk_dir/", help='the dir to save logs and models')
    parser.add_argument(
